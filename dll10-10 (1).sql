...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "ADMINISTRADOR"."SEQ_CEL_ID"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 41 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "ADMINISTRADOR"."SEQ_CURSO_ID"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 41 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "ADMINISTRADOR"."SEQ_FAMILIA_ID"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 41 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "ADMINISTRADOR"."SEQ_POSTALUM_ID"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 41 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "ADMINISTRADOR"."SEQ_PROGRAMA_ID"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 41 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence SEQ_USUARIO_ID
--------------------------------------------------------

   CREATE SEQUENCE  "ADMINISTRADOR"."SEQ_USUARIO_ID"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
REM INSERTING into ADMINISTRADOR.ALUMNO
SET DEFINE OFF;
Insert into ADMINISTRADOR.ALUMNO (ID_ALUM,RUT,NOMBRE,APELLIDO_MATERNO,APELLIDO_PATERNO,CORREO,USUARIO,PASS) values ('1','17977793-2','CLAUDIO','ESTAY','MIRANDA','ASJKAJSAS','yuki91','123456');
REM INSERTING into ADMINISTRADOR.CEL
SET DEFINE OFF;
Insert into ADMINISTRADOR.CEL (ID_CEL,NOMBRE,DIRECCION,CORREO,TELEFONO,USUARIO,PASS,PAIS_ID_PAIS) values ('22','CENTRO GUADALAJARA','GUADALAJARA','GUADA@GMAIL','123456789','guada','123','1');
Insert into ADMINISTRADOR.CEL (ID_CEL,NOMBRE,DIRECCION,CORREO,TELEFONO,USUARIO,PASS,PAIS_ID_PAIS) values ('23','TEST','VS','TEST@VS.CL','123','testvs','123','1');
Insert into ADMINISTRADOR.CEL (ID_CEL,NOMBRE,DIRECCION,CORREO,TELEFONO,USUARIO,PASS,PAIS_ID_PAIS) values ('24','TEST','VS','CBO PAIS','123456','cbopais','123','1');
REM INSERTING into ADMINISTRADOR.CERTIFICADO
SET DEFINE OFF;
REM INSERTING into ADMINISTRADOR.CURSO
SET DEFINE OFF;
Insert into ADMINISTRADOR.CURSO (ID_CURSO,ESTADO,PROGRAMA_ID_PROGRAM,CANTIDAD) values ('21','CR','21','1');
REM INSERTING into ADMINISTRADOR.DETALLE_ALUM
SET DEFINE OFF;
Insert into ADMINISTRADOR.DETALLE_ALUM (ID_DETALLE,ESTADO,ALUMNO_ID_ALUM) values ('21','RE','1');
REM INSERTING into ADMINISTRADOR.FAMILIA
SET DEFINE OFF;
Insert into ADMINISTRADOR.FAMILIA (ID_FAMILIA,APELLIDO_FAMILIA,JEFE_FAMILIA,INTEGRANTES,HABITACIONES,DIRECCION,USUARIO,PASS,ESTADO,CEL_ID_CEL) values ('21','PEREZ GUTIERREZ','MARTA','3','5','SU CASITA','MARTA','123','ND','22');
REM INSERTING into ADMINISTRADOR.FOTOS
SET DEFINE OFF;
REM INSERTING into ADMINISTRADOR.NOTAS
SET DEFINE OFF;
REM INSERTING into ADMINISTRADOR.PAIS
SET DEFINE OFF;
Insert into ADMINISTRADOR.PAIS (ID_PAIS,NOMBRE,IDIOMA,CODIGO) values ('1','MEXICO','ESPAÑOL','MX');
REM INSERTING into ADMINISTRADOR.POST_ALUM
SET DEFINE OFF;
Insert into ADMINISTRADOR.POST_ALUM (ID_POST,TIPO_SEGURO,RESERVA_DINERO,CURSO_ID_CURSO,ALUMNO_ID_ALUM,POST_FAMILIA,ESTADO) values ('24','DE VIDA','1000000','21','1','21','AC');
REM INSERTING into ADMINISTRADOR.POST_CEL
SET DEFINE OFF;
Insert into ADMINISTRADOR.POST_CEL (ID_POST,ESTADO,PROGRAMA_ID_PROGRAM,CEL_ID_CEL) values ('23','AC','21','22');
REM INSERTING into ADMINISTRADOR.PROGRAMA
SET DEFINE OFF;
Insert into ADMINISTRADOR.PROGRAMA (ID_PROGRAM,NOMBRE,CUPO_MAXIMO,CUPO_MINIMO,TIPO,FECHA_INICIO,FECHA_TERMINO,ESTADO) values ('21','PROG ANDROID','20','10','VE',to_date('04/01/19','DD/MM/RR'),to_date('04/03/19','DD/MM/RR'),'PU');
...
PROCEDURE SP_VERIFICAR_POSTULACION(
P_ID IN post_alum.id_post%TYPE);
...
,P_PASS IN FAMILIA.PASS%TYPE
, P_ESTADO IN  familia.estado%TYPE
, P_CEL_ID IN  familia.cel_id_cel%TYPE) AS
  BEGIN
    INSERT INTO FAMILIA(
  APELLIDO_FAMILIA,
  JEFE_FAMILIA,
...
PROCEDURE SP_VERIFICAR_POSTULACION(
P_ID IN post_alum.id_post%TYPE) AS
BEGIN
--UPDATE  PA
--SET PA.ESTADO = 'AP'
--FROM POST_ALUM AS PA
--INNER JOIN DETALLE_ALUM AS DA
--ON PA.ALUMNO_ID_ALUM = DA.ALUMNO_ID_ALUM
--WHERE DA.ESTADO = 'RE' AND
--PA.ID_POST = P_ID;
--COMMIT;
null;
END SP_VERIFICAR_POSTULACION;
END PKG_POST_ALUM;
...
p_tipo in programa.tipo%type,
p_inicio in programa.fecha_inicio%type,
p_termino in programa.fecha_termino%type) AS
  BEGIN
